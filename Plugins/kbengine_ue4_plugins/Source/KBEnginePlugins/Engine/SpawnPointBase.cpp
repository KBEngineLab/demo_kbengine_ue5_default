...
void SpawnPointBase::onGetBase()
{
	...
	pBaseEntityCall = new EntityBaseEntityCall_SpawnPointBase(id(), className());
}

void SpawnPointBase::onGetCell()
{
	if(pCellEntityCall)
		delete pCellEntityCall;

	pCellEntityCall = new EntityCellEntityCall_SpawnPointBase(id(), className());
}

void SpawnPointBase::onLoseCell()
{
	delete pCellEntityCall;
	pCellEntityCall = NULL;
}

EntityCall* SpawnPointBase::getBaseEntityCall()
{
	return pBaseEntityCall;
}

EntityCall* SpawnPointBase::getCellEntityCall()
{
	return pCellEntityCall;
}

void SpawnPointBase::onRemoteMethodCall(MemoryStream& stream)
{
}

void SpawnPointBase::onUpdatePropertys(MemoryStream& stream)
{
	ScriptModule* sm = *EntityDef::moduledefs.Find("SpawnPoint");
...
void SpawnPointBase::callPropertysSetMethods()
{
